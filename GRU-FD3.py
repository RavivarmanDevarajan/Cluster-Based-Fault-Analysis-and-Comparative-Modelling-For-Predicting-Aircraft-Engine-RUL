...
df_test_FD1=df_test_FD3.drop(columns=columns_to_drop)
...
model = Sequential([
    ...
    GRU(64, activation='tanh', return_sequences=True, kernel_regularizer=l2(0.001)),
    BatchNormalization(),
    Dropout(0.3),

    GRU(32, activation='tanh', return_sequences=False, kernel_regularizer=l2(0.001)),
    BatchNormalization(),
    Dropout(0.3),
